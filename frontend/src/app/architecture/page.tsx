        ...
        <div className="space-y-10 text-sm text-neutral-600 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              rate limits, then combined into a single unified transcript.
            </p>
          </section>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-semibold text-neutral-900">
              Structured Summarization & Resilience
            </h2>
            <p>
              Once transcription completes, Gemini analyzes the text and produces a clean JSON
              summary with an executive overview, key takeaways, and action items. If any step
              fails, the error is captured visibly on the note. If summarization fails after
              transcription, retrying skips speech recognition and only re-runs the summary.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              uploaded audio files are stored in Supabase Storage (with automatic fallback to local
